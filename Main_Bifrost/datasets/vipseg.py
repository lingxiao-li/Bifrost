...
class VIPSegDataset(BaseDataset):
    ...
    def get_sample(self, idx):
        ...
        ref_mask_path = ref_image_path.replace('images','panomasks').replace('.jpg', '.png')
        tar_mask_path = tar_image_path.replace('images','panomasks').replace('.jpg', '.png')
        tar_depth_path = tar_image_path.replace('images','depth').replace('.jpg', '.png')
        ...
        tar_depth = cv2.imread(tar_depth_path, cv2.IMREAD_UNCHANGED)
