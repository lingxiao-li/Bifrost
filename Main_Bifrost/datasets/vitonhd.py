...
class VitonHDDataset(BaseDataset):
    ...
    def get_sample(self, idx):
        ...
        tar_depth_path = ref_image_path.replace('/cloth/', '/depth/').replace('.jpg','.png')
        ...
        item_with_collage = self.process_pairs(ref_image, ref_mask, tar_image, tar_mask, tar_depth, max_ratio=1.0)
