...
def save_dataset(dataset_name, output_folder, class_name, subset_name, val_samples=None):
    ...
    dataset = load_dataset(
        "parquet", data_dir='/home/zhangyuanyuan/Lingxiao/datasets/datasets--Multimodal-Fatima--OK-VQA_train/data', data_files=dataset_name)

    print(dataset)
    # Filter for images with the specified class in 'question_type'
    filtered_dataset = [
        item for item in dataset if item['question_type'] == class_name]
...
class_name = 'other'
val_samples = 300
train_data_file = {'train': '/home/zhangyuanyuan/Lingxiao/datasets/datasets--Multimodal-Fatima--OK-VQA_train/data/train-00000-of-00004-2eec69cac51b3951.parquet'}
save_dataset(train_data_file,
             output_folder, class_name, 'train', val_samples)
save_dataset('Multimodal-Fatima/OK-VQA_test',
             output_folder, class_name, 'test')
